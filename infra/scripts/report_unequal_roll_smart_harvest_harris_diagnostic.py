...
FIELD_LINEAGE_OVERRIDES = {
    ...
    "effective_age": {
        ...
        "scoring_input_available": True,
        "final_value_review_evidence_available": True,
        "lineage_note": "Available through runtime and now surfaced in review-only evidence export paths.",
    },
    "year_built": {
    ...
    "frontage": {
        ...
        "scoring_input_available": False,
        "final_value_review_evidence_available": True,
        "lineage_note": "Available upstream and now propagated through review-only snapshot, candidate payload, and review evidence paths without affecting scoring.",
    },
    "depth": {
