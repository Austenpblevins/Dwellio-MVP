...
- `run_weekly_quote_quality_monitor.py`: scheduler-friendly wrapper for `report_quote_quality_monitor.py` that writes durable artifacts, a manifest, and a no-op alert payload for later alert-provider wiring.
